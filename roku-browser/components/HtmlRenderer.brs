    ...
    while i < tokenCount and m.nodeCount < m.maxNodes
        ...
        if token.kind = "text"
            ...
            if tag = "h1" or tag = "h2" or tag = "h3" or tag = "h4" or tag = "h5" or tag = "h6"
                ...
                addSpacer(2)
                renderTextNode("  " + chr(8226) + "  ", currentStyle)
...
function decodeEntities(text as string) as string
    ...
    result = replaceAll(result, "&#x27;", "'")
    result = replaceAll(result, "&#x2F;", "/")
    result = replaceAll(result, "&mdash;", chr(8212))
    result = replaceAll(result, "&ndash;", chr(8211))
    result = replaceAll(result, "&laquo;", chr(171))
    result = replaceAll(result, "&raquo;", chr(187))
    result = replaceAll(result, "&copy;", chr(169))
    result = replaceAll(result, "&reg;", chr(174))
    result = replaceAll(result, "&trade;", chr(8482))
    result = replaceAll(result, "&hellip;", chr(8230))
    result = replaceAll(result, "&bull;", chr(8226))
    result = replaceAll(result, "&#8211;", chr(8211))
    result = replaceAll(result, "&#8212;", chr(8212))
    result = replaceAll(result, "&#8216;", "'")
    result = replaceAll(result, "&#8217;", "'")
    result = replaceAll(result, "&#8220;", chr(34))
    result = replaceAll(result, "&#8221;", chr(34))
